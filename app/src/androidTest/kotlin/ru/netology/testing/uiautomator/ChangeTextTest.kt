...
class ChangeTextTest {
    ...
    private val titlePage = context.resources.getString(R.string.hello_world);
//    @Test
...
//    }
    ...
    fun testEmptyField() {
        ...
        var textAfterChange = device.findObject(By.res(packageName, "textToBeChanged")).text

        assertEquals(textAfterChange, textAfterChange)

        device.findObject(By.res(packageName, "userInput")).text = "             "
        device.findObject(By.res(packageName, "buttonChange")).click()

        textAfterChange = device.findObject(By.res(packageName, "textToBeChanged")).text

        assertEquals(textAfterChange, titlePage)
    }
